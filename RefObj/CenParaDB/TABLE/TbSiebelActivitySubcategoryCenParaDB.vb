...
Namespace TABLE
    'Represents a transaction for TB_SIEBEL_ACTIVITY_SUBCATEGORY table Parameter.
    '[Create by  on January, 29 2015]

    <Table(Name:="TB_SIEBEL_ACTIVITY_SUBCATEGORY")>  _
    Public Class TbSiebelActivitySubcategoryCenParaDB
