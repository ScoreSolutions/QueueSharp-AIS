...
Namespace TABLE
    ...
    Public Class TbFilterDataCenLinqDB
        ...
        Dim _NETWORK_TYPE As String = "2G"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_FILTER_DATA by specified QUEUE_UNIQUE_ID key is retrieved successfully.
        '/// <param name=cQUEUE_UNIQUE_ID>The QUEUE_UNIQUE_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByQUEUE_UNIQUE_ID(cQUEUE_UNIQUE_ID As String, trans As SQLTransaction) As Boolean
            Return doChkData("QUEUE_UNIQUE_ID = " & DB.SetString(cQUEUE_UNIQUE_ID) & " ", trans)
        End Function

        '/// Returns an duplicate data record of TB_FILTER_DATA by specified QUEUE_UNIQUE_ID key is retrieved successfully.
        '/// <param name=cQUEUE_UNIQUE_ID>The QUEUE_UNIQUE_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByQUEUE_UNIQUE_ID(cQUEUE_UNIQUE_ID As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("QUEUE_UNIQUE_ID = " & DB.SetString(cQUEUE_UNIQUE_ID) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SERVICE_DATE, QUEUE_NO, QUEUE_UNIQUE_ID, MOBILE_NO, CUSTOMER_NAME, USERNAME, TB_FILTER_ID, TB_ITEM_ID, TEMPLATE_CODE, FILTER_TIME, SEND_TIME, RESULT_TIME, RESULT_STATUS, RESULT, SEND_TO_SHOP_TIME, ATSR_CALL_TIME, END_TIME, NETWORK_TYPE, NPS_SCORE, ACTIVITY_ID_SURVEY, ACTIVITY_ID_LEAVE_VOICE, STAFF_NAME, SEGMENT FROM " & tableName
                Return Sql
            End Get
        End Property
