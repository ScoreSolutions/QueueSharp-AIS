...
Namespace TABLE
    ...
    Public Class TbCfgUserCenLinqDB
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_CFG_USER by specified EVENT_STATUS_SHOP_ID_USERNAME key is retrieved successfully.
        '/// <param name=cEVENT_STATUS_SHOP_ID_USERNAME>The EVENT_STATUS_SHOP_ID_USERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByEVENT_STATUS_SHOP_ID_USERNAME(cEVENT_STATUS As String, cSHOP_ID As Integer, cUSERNAME As String, trans As SQLTransaction) As Boolean
            Return doChkData("EVENT_STATUS = " & DB.SetString(cEVENT_STATUS) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID) & " AND USERNAME = " & DB.SetString(cUSERNAME), trans)
        End Function

        '/// Returns an duplicate data record of TB_CFG_USER by specified EVENT_STATUS_SHOP_ID_USERNAME key is retrieved successfully.
        '/// <param name=cEVENT_STATUS_SHOP_ID_USERNAME>The EVENT_STATUS_SHOP_ID_USERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByEVENT_STATUS_SHOP_ID_USERNAME(cEVENT_STATUS As String, cSHOP_ID As Integer, cUSERNAME As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("EVENT_STATUS = " & DB.SetString(cEVENT_STATUS) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID) & " AND USERNAME = " & DB.SetString(cUSERNAME) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
