...
Namespace TABLE
    ...
    Public Class TbItemCenLinqDB
        ...
        Public Property TB_ITEM_GROUP_ID() As  System.Nullable(Of Long) 
            ...
            End Set
        End Property 
        <Column(Storage:="_BRAND_NAME", DbType:="VarChar(100)")>  _
       ...
       'Define Public Method 
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("Brand_Name")) = False Then ret.Brand_Name = Rdr("Brand_Name").ToString()
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, ITEM_CODE, ITEM_NAME, ITEM_NAME_TH, ITEM_TIME, ITEM_WAIT, ITEM_ORDER, TXT_QUEUE, COLOR, ACTIVE_STATUS, Q_TYPE_ID, APP_MIN_QUEUE, APP_MAX_QUEUE, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TB_ITEM_GROUP_ID, BRAND_NAME)"
                Sql += " VALUES("
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "BRAND_NAME = " & DB.SetString(_BRAND_NAME) + ""
                Return Sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, ITEM_CODE, ITEM_NAME, ITEM_NAME_TH, ITEM_TIME, ITEM_WAIT, ITEM_ORDER, TXT_QUEUE, COLOR, ACTIVE_STATUS, Q_TYPE_ID, APP_MIN_QUEUE, APP_MAX_QUEUE, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TB_ITEM_GROUP_ID, BRAND_NAME FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _TB_FILTER_SERVICE_tb_item_id As DataTable
       Dim _TB_FILTER_TEMP_TARGET_tb_item_id As DataTable
       Dim _TB_REP_SUMMARY_DAILY_REPORT_item_id As DataTable
       Dim _TB_REP_SUMMARY_REPORT_INTERVAL_item_id As DataTable
       Dim _TB_REP_SUMMARY_REPORT_STAFF_item_id As DataTable
       Dim _TB_SHOP_SERVICE_APPOINTMENT_master_itemid As DataTable
       Dim _TB_SKILL_ITEM_item_id As DataTable

       Public Property CHILD_TB_FILTER_SERVICE_tb_item_id() As DataTable
           Get
               'Child Table Name : TB_FILTER_SERVICE Column :tb_item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbFilterServiceItem As New TbFilterServiceCenLinqDB
               _TB_FILTER_SERVICE_tb_item_id = TbFilterServiceItem.GetDataList("tb_item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbFilterServiceItem = Nothing
               Return _TB_FILTER_SERVICE_tb_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_FILTER_SERVICE_tb_item_id = value
           End Set
       End Property
       Public Property CHILD_TB_FILTER_TEMP_TARGET_tb_item_id() As DataTable
           Get
               'Child Table Name : TB_FILTER_TEMP_TARGET Column :tb_item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbFilterTempTargetItem As New TbFilterTempTargetCenLinqDB
               _TB_FILTER_TEMP_TARGET_tb_item_id = TbFilterTempTargetItem.GetDataList("tb_item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbFilterTempTargetItem = Nothing
               Return _TB_FILTER_TEMP_TARGET_tb_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_FILTER_TEMP_TARGET_tb_item_id = value
           End Set
       End Property
       Public Property CHILD_TB_REP_SUMMARY_DAILY_REPORT_item_id() As DataTable
           Get
               'Child Table Name : TB_REP_SUMMARY_DAILY_REPORT Column :item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbRepSummaryDailyReportItem As New TbRepSummaryDailyReportCenLinqDB
               _TB_REP_SUMMARY_DAILY_REPORT_item_id = TbRepSummaryDailyReportItem.GetDataList("item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbRepSummaryDailyReportItem = Nothing
               Return _TB_REP_SUMMARY_DAILY_REPORT_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_REP_SUMMARY_DAILY_REPORT_item_id = value
           End Set
       End Property
       Public Property CHILD_TB_REP_SUMMARY_REPORT_INTERVAL_item_id() As DataTable
           Get
               'Child Table Name : TB_REP_SUMMARY_REPORT_INTERVAL Column :item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbRepSummaryReportIntervalItem As New TbRepSummaryReportIntervalCenLinqDB
               _TB_REP_SUMMARY_REPORT_INTERVAL_item_id = TbRepSummaryReportIntervalItem.GetDataList("item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbRepSummaryReportIntervalItem = Nothing
               Return _TB_REP_SUMMARY_REPORT_INTERVAL_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_REP_SUMMARY_REPORT_INTERVAL_item_id = value
           End Set
       End Property
       Public Property CHILD_TB_REP_SUMMARY_REPORT_STAFF_item_id() As DataTable
           Get
               'Child Table Name : TB_REP_SUMMARY_REPORT_STAFF Column :item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbRepSummaryReportStaffItem As New TbRepSummaryReportStaffCenLinqDB
               _TB_REP_SUMMARY_REPORT_STAFF_item_id = TbRepSummaryReportStaffItem.GetDataList("item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbRepSummaryReportStaffItem = Nothing
               Return _TB_REP_SUMMARY_REPORT_STAFF_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_REP_SUMMARY_REPORT_STAFF_item_id = value
           End Set
       End Property
       Public Property CHILD_TB_SHOP_SERVICE_APPOINTMENT_master_itemid() As DataTable
           Get
               'Child Table Name : TB_SHOP_SERVICE_APPOINTMENT Column :master_itemid
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbShopServiceAppointmentItem As New TbShopServiceAppointmentCenLinqDB
               _TB_SHOP_SERVICE_APPOINTMENT_master_itemid = TbShopServiceAppointmentItem.GetDataList("master_itemid = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbShopServiceAppointmentItem = Nothing
               Return _TB_SHOP_SERVICE_APPOINTMENT_master_itemid
           End Get
           Set(ByVal value As DataTable)
               _TB_SHOP_SERVICE_APPOINTMENT_master_itemid = value
           End Set
       End Property
       Public Property CHILD_TB_SKILL_ITEM_item_id() As DataTable
           Get
               'Child Table Name : TB_SKILL_ITEM Column :item_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbSkillItemItem As New TbSkillItemCenLinqDB
               _TB_SKILL_ITEM_item_id = TbSkillItemItem.GetDataList("item_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbSkillItemItem = Nothing
               Return _TB_SKILL_ITEM_item_id
           End Get
           Set(ByVal value As DataTable)
               _TB_SKILL_ITEM_item_id = value
           End Set
       End Property
    End Class
End Namespace
