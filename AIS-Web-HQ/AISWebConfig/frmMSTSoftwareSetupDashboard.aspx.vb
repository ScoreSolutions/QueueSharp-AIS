...
Partial Class frmMSTSoftwareSetupDashboard
    ...
    Protected Sub btn_save_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save.Click
        ...
        If ctlBrowseFileLogo.HasFile = True Then
            If ctlBrowseFileLogo.TmpFileUploadPara.FileExtent.ToUpper <> ".PNG" Then
                Config.ShowAlert("Logo file Extention is .PNG only", Me)
                ctlBrowseFileLogo.ClearFile()
                Exit Sub
            End If
        End If
        ...
        If ret = True Then
            ...
            If ctlBrowseFileLogo.HasFile = True Then
                Dim FileByteID As Long = SaveImageFile(uPara.USERNAME, vDateSchedule, "9", ctlBrowseFileLogo, trans)
        ...
        End If
        uPara = Nothing
        Config.SaveTransLog("บันทึกข้อมูล : Software Setup >> Dashboard", "AisWebConfig.frmMSTSoftwareSetupDashboard.aspx.aspx.btn_save_Click", Config.GetLoginHistoryID)
    ...
    Private Function GetDataTabView(ByVal wh As String) As DataTable
        ...
        If shDt.Rows.Count > 0 Then
            For Each shDr As DataRow In shDt.Rows
                Dim shTrans As ShLinqDB.Common.Utilities.TransactionDB = Engine.Common.FunctionEng.GetShTransction(shDr("id"), "frmMSTSoftwareSetupDashboard_GetDataTabView")
...
#Region "TabView Filter Dropdownlist"
    ...
    '            'BindTabView("")
    '        End If
    '        Config.SaveTransLog("ค้นหาข้อมูลตาม Shop Size : Software Setup >> Dashboard", "AisWebConfig.frmMSTSoftwareSetupDashboard.aspx.ddshop_size_SelectedIndexChanged", Config.GetLoginHistoryID)
    ...
    '            BindTabView("")
    '        End If
    '        Config.SaveTransLog("ค้นหาข้อมูลตาม Shop Name : Software Setup >> Dashboard", "AisWebConfig.frmMSTSoftwareSetupDashboard.aspx.ddshop_name_SelectedIndexChanged", Config.GetLoginHistoryID)
    ...
    '        BindTabView("")
    '    End If
    '    Config.SaveTransLog("ค้นหาข้อมูลตามความหน่วงของไฟล์ video(second) : Software Setup >> Dashboard", "AisWebConfig.frmMSTSoftwareSetupDashboard.aspx.ddmain_retardation_video_SelectedIndexChanged", Config.GetLoginHistoryID)
    ...
    Protected Sub lbl_shop_Name_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            Binddata(lblID.Text)
            Config.SaveTransLog("เลือกข้อมูล - " & lbl_shop_Name.Text & " : Software Setup >> Dashboard", "AisWebConfig.frmMSTSoftwareSetupDashboard.aspx.lbl_shop_Name_Click", Config.GetLoginHistoryID)
