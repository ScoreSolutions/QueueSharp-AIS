<%@ Page Title="" Language="VB" MasterPageFile="~/TemplateMaster.master" AutoEventWireup="false" CodeFile="frmShopLogoutReason.aspx.vb" Inherits="frmShopLogoutReason" %>
    ...
    <table style="width: 900px;">
        <tr>
            <td class="tableHeader">
                <asp:Label ID="Label2" runat="server" Text="Shop Setup >> Logout Reason"></asp:Label>
            </td>
        </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <td style="width: 150px; height: 27px" class="dvtCellLabel">
                            Master Logout Reason :
                        </td>
                        <td class="dvtCellInfo">
                            <asp:DropDownList ID="ddlMasterLogoutReason" runat="server" Width="200px" AutoPostBack="true" ></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="dvtCellInfo">
                            <asp:TextBox runat="server" ID="txt_logout_reason" class="TextView"
                    ...
                    <tr>
                        ...
                        <td class="dvtCellLabel">
                            <asp:CheckBox runat="server" Text="Productive" ID="chk_logout_reason_productive" Enabled="false" >
                            </asp:CheckBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="dvtCellLabel">
                            <asp:CheckBox runat="server" Text="Active" ID="chk_logout_reason_active" Enabled="false" >
                            </asp:CheckBox>
                        </td>
                    </tr>
                </table>
