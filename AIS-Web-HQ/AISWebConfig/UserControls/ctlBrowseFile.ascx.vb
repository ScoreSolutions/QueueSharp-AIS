...
Partial Class UserControls_ctlBrowseFile
    ...
    Public Sub SaveFile(ByVal PathFile As String, ByVal fileName As String)
        ...
        If TempName <> "" Then
            Try
                Dim fs As FileStream
                Dim byteData() As Byte = File.ReadAllBytes(TempName)
                ...
                ClearFile()
            Catch ex As Exception
                Engine.Common.FunctionEng.SaveErrorLog("UserControls_ctlBrowseFile.SaveFile", ex.Message & vbNewLine & ex.StackTrace)
            End Try
        End If
    End Sub
End Class
