<%@ Page Title="" Language="VB" MasterPageFile="~/TemplateMaster.master" AutoEventWireup="false"
    CodeFile="frmMSTLogOutReason.aspx.vb" Inherits="frmMSTLogOutReason" %>
    ...
    <table style="width: 900px" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="tableHeader">
                <asp:Label ID="Label2" runat="server" Text="Central Setup >> Logout Reason"></asp:Label>
            </td>
        </tr>
        <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 70%;">
                    <tr>
                        ...
                        <td class="dvtCellInfo">
                            <asp:TextBox ID="txt_reason" runat="server" class="detailedViewTextBox" MaxLength="100"
        ...
        <tr>
            <td colspan='2'>
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                        <td style="height: 14px; width: 675px; text-align: right;" class="dvtCellInfo">
                            <Saifi:MyDg ID="dgvLogOutReasonList" runat="server" allowpaging="true" AutoGenerateColumns="False" CssClass="Grid_inq"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Reason" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lbl_skill" runat="server" Style="text-align: left; width: 100%;" Text='<%#DataBinder.Eval(Container.DataItem, "Name")%>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="200px" />
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Productive" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px">
                                        <ItemTemplate>
