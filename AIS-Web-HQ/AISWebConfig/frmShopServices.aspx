<%@ Page Title="" Language="VB" MasterPageFile="~/TemplateMaster.master" AutoEventWireup="false" CodeFile="frmShopServices.aspx.vb" Inherits="frmShopServices" %>
    ...
    <table style="width: 900px" border="0" cellpadding="0" cellspacing="0" >
        <tr>
            <td class="tableHeader">
                <asp:Label ID="Label2" runat="server" Text="Shop Setup >> Service"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <table style="width:700px;">
                    <tr>
                        <td style="height: 27px" class="dvtCellLabel">* Master Item :</td>
                        <td style="width: 19px" class="dvtCellInfo">
                            <asp:DropDownList ID="ddlMasterItem" runat="server" Width="150px" AutoPostBack="true" >
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        <td class="dvtCellLabel">Item Code :</td>
                        <td class="dvtCellInfo">
                            <asp:TextBox ID="txt_item_code" runat="server" class="TextView" MaxLength="20"
                    ...
                    <tr>
                        ...
                        <td style="width: 19px" class="dvtCellInfo">
                            <asp:TextBox ID="txt_item_name_english" runat="server" class="TextView"  
                                OnKeyPress="txtKeyPress(event)" onKeyDown="CheckKeyBackSpace(event)"
                                Width="150px" Height="20px"></asp:TextBox>
                        </td>
                        <td style="width: 150px; height: 27px" class="dvtCellLabel">
                        ...
                        <td class="dvtCellInfo" style="width: 150px;">
                            <asp:TextBox ID="txt_item_name_thai" runat="server" class="TextView" MaxLength="50"
                                OnKeyPress="txtKeyPress(event)" onKeyDown="CheckKeyBackSpace(event)"
                                Width="150px" Height="20px"></asp:TextBox>
                        </td>
                        <td class="dvtCellInfo" style="width: 150px;">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 19px" class="dvtCellInfo">
                            <table style="width: 80%;">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txt_appointment_queue_no_min" runat="server"  MaxLength="3"
                                    ...
                                    <td>-</td>
                                    <td>
                                        <asp:TextBox ID="txt_appointment_queue_no_max" runat="server"  MaxLength="3"
                                            Width="60px" Height="20px"></asp:TextBox>
                        ...
                        <td class="dvtCellInfo" colspan="2">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txt_queue" runat="server"  MaxLength="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 19px" class="dvtCellInfo">
                            <asp:TextBox ID="txt_item_order2" runat="server" class="TextView"  MaxLength="1"
                                OnKeyPress="txtKeyPress(event)" onKeyDown="CheckKeyBackSpace(event)"
                                Width="150px" Height="20px"></asp:TextBox>
                            <asp:TextBox ID="txt_item_order" runat="server"  MaxLength="1"
                               Width="150px" Height="20px" ></asp:TextBox> 
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 19px" class="dvtCellInfo">
                                <asp:TextBox ID="txt_standard_handing_time" runat="server" class="TextView" MaxLength="100" 
                                    OnKeyPress="txtKeyPress(event)" onKeyDown="CheckKeyBackSpace(event)"
                                    Width="150px" Height="20px"></asp:TextBox>
                        </td>
                        <td style="width: 150px; height: 27px" class="dvtCellLabel">
                        ...
                        <td style="width: 150px; height: 27px" class="dvtCellInfo">
                            <asp:CheckBox ID="chk_vasily" runat="server" Text="Vasily" Enabled="false" Checked="true"  />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 19px" class="dvtCellInfo">
                            <asp:TextBox ID="txt_standard_waiting_time" runat="server" class="TextView" MaxLength="100" 
                                OnKeyPress="txtKeyPress(event)" onKeyDown="CheckKeyBackSpace(event)"
                                Width="150px" Height="20px"></asp:TextBox>
                        </td>
                        <td style="width: 46px" class="dvtCellLabel">Min</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
