    ...
    Public Class LoginENG
        ...
        Public Function CSIGetLDAP(ByVal UserName As String, ByVal PassWD As String) As CenParaDB.GateWay.LDAPResponsePara
            ...
            If para.RESULT = False Then
                ...
                para.RESPONSE_MSG = "User or password invalid"
            End If
            Return para
        End Function
        ...
        Public Function GetShopListByUser(ByVal UserName As String, Optional ByVal IsActive As Boolean = False) As DataTable
            Dim dt As New DataTable
            If UserName.ToUpper <> "ADMIN" Then
                Dim sql As String = "select s.*, "
                sql += " r.location_group, r.region_name_en, r.region_code"
                sql += " from tb_shop s"
