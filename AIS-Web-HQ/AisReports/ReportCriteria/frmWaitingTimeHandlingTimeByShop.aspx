<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmWaitingTimeHandlingTimeByShop.aspx.vb" Inherits="ReportCriteria_frmWaitingTimeHandlingTimeByShop" %>
            ...
            <table width="100%">
                <tr>
                    <th width="50%" height="23" id="Th1" style="color: #92b733"  align="left" >
                        Waiting Time and Handling Time by Shop Report</th>
