Imports System.Data
Partial Class ReportCriteria_frmProductivity
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If ShopID.Trim = "" Then
            ScriptManager.RegisterStartupScript(Me, GetType(String), "OnClick", "<script>alert('กรุณาเลือกช็อปที่ต้องการแสดงรายงาน !!')</script>", False)
            Exit Sub
        End If
        ...
        End If
        Config.SaveTransLog("เรียกดูรายงาน : Productivity Report เงื่อนไข :" & para, "AisReports.ReportCriteria_frmProductivity.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repProductivity.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
