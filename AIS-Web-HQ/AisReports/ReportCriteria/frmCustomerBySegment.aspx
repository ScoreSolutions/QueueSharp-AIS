<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmCustomerBySegment.aspx.vb" Inherits="ReportCriteria_frmCustomerBySegment" %>
            ...
            <table width="100%">
                <tr>
                    <th width="50%" height="23" id="Th1" style="color: #92b733"  align="left" >
                        Customer Contact by Segment Report
                    </th>
