...
Partial Class ReportCriteria_frmWaitingTimeHandlingTimeByAgent
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Config.SaveTransLog("เรียกดูรายงาน : Waiting Time and Handling Time by Staff Report เงื่อนไข :" & para, "AisReports.ReportCriteria_frmWaitingTimeHandlingTimeByAgent.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repWaitingTimeHandlingTimeByAgent.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
