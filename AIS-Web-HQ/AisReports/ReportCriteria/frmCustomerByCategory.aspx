<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmCustomerByCategory.aspx.vb" Inherits="ReportCriteria_frmCustomerByCategory" %>
        ...
        <td>
            <table width="100%">
                <tr>
                    <th width="50%" height="23" id="Th1" style="color: #92b733"  align="left" >
                        Customer Contact by Category/Sub Category Report
                    </th>
                    <th width="50%" class="title_page_current" id="screenName" >&nbsp;</th>
                </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr style="height:35px">
                    ...
                    <td colspan="3" align="left">
                        <asp:RadioButtonList ID="rdiReportBy" runat="server" AutoPostBack="true" 
