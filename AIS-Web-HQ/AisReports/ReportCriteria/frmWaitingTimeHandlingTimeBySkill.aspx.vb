Imports System.Data
Partial Class ReportCriteria_frmWaitingTimeHandlingTimeBySkill
    ...
    Private Sub chkAllShop_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkAllSkill.CheckedChanged
        If chkAllSkill.Checked = True Then
            For i As Integer = 0 To chkSkillId.Items.Count - 1
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Config.SaveTransLog("เรียกดูรายงาน : Waiting Time and Handling Time by Skill Report เงื่อนไข :" & para, "AisReports.ReportCriteria_frmWaitingTimeHandlingTimeBySkill.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repWaitingTimeHandlingTimeBySkill.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
