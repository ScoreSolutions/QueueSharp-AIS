Imports System.Data
Partial Class ReportCriteria_frmCustomerByNetwork
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        End If
        Config.SaveTransLog("เรียกดูรายงาน : Customer Contact by Network Report เงื่อนไข :" & para, "AisReports.ReportCriteria_frmCustomerByNetwork.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repCustomerByNetwork.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
