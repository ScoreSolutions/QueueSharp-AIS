Imports System.Data
Partial Class ReportCriteria_frmCustomerBySegment
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Config.SaveTransLog("เรียกดูรายงาน : Customer Contact by Segment Report เงื่อนไข :" & para, "AisReports.ReportCriteria_frmCustomerBySegment.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repCustomerBySegment.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
