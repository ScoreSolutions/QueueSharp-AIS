<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmDailyReport.aspx.vb" Inherits="ReportCriteria_frmDailyReport" %>
            ...
            <table width="100%">
                <tr>
                    <th height="23" id="Th1" style="color: #92b733"  align="left" class="style3" >
                        Daily Performance Report By Network and Service Type of Shop BKK and UPC</th>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="3" align="left" >
                        ...
                        <ServiceType:ddlServiceType ID="ddlServiceType" runat="server" 
                    Visible="True" />
