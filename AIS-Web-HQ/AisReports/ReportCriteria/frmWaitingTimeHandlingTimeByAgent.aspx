<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmWaitingTimeHandlingTimeByAgent.aspx.vb" Inherits="ReportCriteria_frmWaitingTimeHandlingTimeByAgent" %>
            ...
            <table width="100%">
                <tr>
                    <th width="50%" height="23" id="Th1" style="color: #92b733"  align="left" >
                        Waiting Time and Handling Time by Staff Report</th>
