...
Partial Class ReportCriteria_frmAvgServiceTimeKPIByAgent
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        ElseIf rdiReportBy.SelectedValue = "Month" Then
            ...
            para += "&rnd" & DateTime.Now.Millisecond
        End If
        Config.SaveTransLog("เรียกดูรายงาน :% Customers Served by staff เงื่อนไข :" & para, "AisReports.ReportCriteria_frmAvgServiceTimeKPIByAgent.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repAvgServiceTimeKPIByAgent.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
