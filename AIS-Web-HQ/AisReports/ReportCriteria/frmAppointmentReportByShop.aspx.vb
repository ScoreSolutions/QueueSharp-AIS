Imports System.Data
Partial Class ReportCriteria_frmAppointmentReportByShop
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If rdiReportBy.SelectedValue = "Time" Then
            ...
            para += "&ShopID=" & ShopID
            para += "&DateFrom=" & ctlByTime1.DateFrom.ToString("yyyyMMdd", New Globalization.CultureInfo("en-US"))
            para += "&DateTo=" & ctlByTime1.DateTo.ToString("yyyyMMdd", New Globalization.CultureInfo("en-US"))
        ...
        ElseIf rdiReportBy.SelectedValue = "Month" Then
            ...
            para += "&rnd" & DateTime.Now.Millisecond
        End If
        Config.SaveTransLog("เรียกดูรายงาน : Appointment Report by Shop เงื่อนไข :" & para, "AisReports.ReportCriteria_frmAppointmentReportByShop.btnSearch_Click", Config.GetLoginHistoryID)
        Dim scr As String = "window.open('../ReportApp/repAppointmentReportByShop.aspx" & para & "', '_blank', 'height=650,left=600,location=no,menubar=no,toolbar=no,status=yes,resizable=yes,scrollbars=yes', true);"
