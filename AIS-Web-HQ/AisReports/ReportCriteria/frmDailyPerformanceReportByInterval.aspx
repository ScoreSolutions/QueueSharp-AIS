<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmDailyPerformanceReportByInterval.aspx.vb" Inherits="ReportCriteria_frmDailyPerformanceReportByInterval" %>
...
<%@ Register src="../FormControls/ctlByTime.ascx" tagname="ctlByTime" tagprefix="uc4" %>
    ...
    <tr align=center>
        <td>
            <table width="100%">
                <tr>
                    <th width="50%" height="23" id="Th1" style="color: #92b733"  align="left" >
                        Daily Interval Report by Network and Service Type of Shop BKK and UPC</th>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td valign="middle" align="right">Service Type :&nbsp;</td>
                    <td colspan="3" align="left" >
                ...
                <uc1:ddlServiceType ID="ddlServiceType1" runat="server"  DataValueField="id" />
                <Shop:ddlShop ID="ddlShop" runat="server" Visible="False" />
                
                <tr style="height:30px" >
                    <td align="right">By Customer Segment :&nbsp;</td>
                    <td colspan="3" align="left" >
                       <asp:DropDownList ID="ddlSegment" runat="server">
                                <asp:ListItem Value="All">All</asp:ListItem>
                                <asp:ListItem Value="MASS">Mass</asp:ListItem>
                                <asp:ListItem Value="SERENADE">Serenade</asp:ListItem>
                       </asp:DropDownList>
                    </td>
                </tr>
                
                <uc4:ctlByTime ID="ctlByTime1" runat="server" ShowDate="false" IsNotNullTime="false" />
                <tr style="height: 30px">
