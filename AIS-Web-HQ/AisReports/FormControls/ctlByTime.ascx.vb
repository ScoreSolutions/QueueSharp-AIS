...
Partial Class FormControls_ctlByTime
    ...
    Public WriteOnly Property ShowDate() As Boolean
        Set(ByVal value As Boolean)
            rowDate.Visible = value
        End Set
    End Property

    Public WriteOnly Property IsNotNullTime() As Boolean
        Set(ByVal value As Boolean)
            DTimePeroidFrom.IsNotNull = value
            DTimePeroidTo.IsNotNull = value
            cmbIntervalMinute.IsNotNull = value
        End Set
    End Property
