...
Partial Class ReportApp_repSummaryShopPerformanceReportByDaily
    Inherits System.Web.UI.Page
    Dim Version As String = System.Configuration.ConfigurationManager.AppSettings("Version")

    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ExportData("application/vnd.xls", "Summary_Shop_Performance_by_Daily_" & DateTime.Now.ToString("yyyyMMddHHmmssffff") & ".xls")
    End Sub
    Private Sub ExportData(ByVal _contentType As String, ByVal fileName As String)
        Config.SaveTransLog("Export Data to " & _contentType, "ReportApp_repSummaryShopPerformanceByDaily.ExportData", Config.GetLoginHistoryID)
    ...
    Private Sub ShowReport(ByVal ShopID As String)
        RenderReport(ShopID, Request("DateFrom"), Request("DateTo"), Request("Day"), Request("NetworkType"), Request("Segment"), Request("ServiceID"))
    ...
    Private Sub RenderReport(ByVal ShopID As String, ByVal DateFrom As String, ByVal DateTo As String, ByVal RepDay As String, ByVal NetworkType As String, ByVal Segment As String, ByVal ServiceID As String)
        ...
        Dim dt As DataTable = lnq.GetDataList(WhText, "service_date,show_day,shop_location_group,item_id,network_type,segment_type,shop_name_en", trans.Trans)
        ...
        If dt.Rows.Count > 0 Then
            ...
            ret.Append("        <td align='center' style='color: #ffffff;' >Day</td>")
            ...
            dDt = dt.DefaultView.ToTable(True, "show_date", "show_day", "shop_location_group", "item_id", "item_name_en", "item_name_th", "network_type", "segment_type")
            dDt.DefaultView.Sort = "show_day,shop_location_group,item_id,network_type,segment_type"
            ...
            If dDt.Rows.Count > 0 Then
                For Each dDr As DataRow In dDt.Rows
                    ...
                    Dim wh As String = "show_day='" & dDr("show_day") & "'"
                    ...
                    If dt.DefaultView.Count > 0 Then
                        ...
                        For Each dr As DataRowView In dt.DefaultView
                            ...
                            ret.Append("        <td align='center'>&nbsp;" & dDr("show_day") & "</td>")
