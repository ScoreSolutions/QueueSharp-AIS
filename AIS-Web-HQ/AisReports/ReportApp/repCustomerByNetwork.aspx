<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repCustomerByNetwork.aspx.vb" Inherits="ReportApp_repCustomerByNetwork" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Customer Contact by Network Report
                </td>
            </tr>
            <tr>
