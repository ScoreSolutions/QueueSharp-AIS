<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repCustomerBySegment.aspx.vb" Inherits="ReportApp_repCustomerBySegment" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Customer Contact by Segment Report
                </td>
            </tr>
            <tr>
                <td align="left" bgcolor="White">&nbsp;<asp:Button ID="btnExport" runat="server" 
                        Text="Export Excel" CssClass="formDialog"/>
                 </td>
            </tr>
            <tr>
                <td>                             
