<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repAvgServiceTimeKPIByShop.aspx.vb" Inherits="ReportApp_repAvgServiceTimeKPIByShop" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : % Customers Served by Shop 
                </td>
            </tr>
            <tr>
