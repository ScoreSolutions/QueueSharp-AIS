<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repAvgServiceTimeKPIBySkill.aspx.vb" Inherits="ReportApp_repAvgServiceTimeKPIBySkill" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Average Service Time comparing with KPI  Report
                </td>
            </tr>
            <tr>
