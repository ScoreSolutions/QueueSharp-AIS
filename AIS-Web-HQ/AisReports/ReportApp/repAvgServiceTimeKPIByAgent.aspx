<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repAvgServiceTimeKPIByAgent.aspx.vb" Inherits="ReportApp_repAvgServiceTimeKPIByAgent" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : % Customers Served by staff
                </td>
            </tr>
            <tr>
