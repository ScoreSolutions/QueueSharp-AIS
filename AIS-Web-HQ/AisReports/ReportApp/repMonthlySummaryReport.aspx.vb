...
Partial Class ReportApp_repMonthlySummaryReport
    Inherits System.Web.UI.Page
    Dim Version As String = System.Configuration.ConfigurationManager.AppSettings("Version")

    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ExportData("application/vnd.xls", "Monthly_Summary_Report_" & DateTime.Now.ToString("yyyyMMddHHmmssffff") & ".xls")
    End Sub
    ...
    Private Sub SetReportName()
        ...
        Dim ReportName As String = "Monthly Summary Report of " & NetworkType & " Customer by Service Type of All Shops in " & LocationCode & ""
    ...
    Private Sub ShowReport(ByVal ReportName As String)
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@Shop", "")
        ...
        Catch ex As Exception
            ...
            Engine.Common.FunctionEng.SaveErrorLog("ReportApp_repMonthlySummaryReport.ShowReport", "Exception :" & ex.Message & vbNewLine & ex.StackTrace)
        End Try
    ...
    Private Sub RenderReportByDate(ByVal dt As DataTable)
        ...
        If dt.Rows.Count > 0 Then
            ...
            For intData As Integer = 0 To dt.Rows.Count - 1
                ...
                Or strKeepService_Year <> dt(intData)("Service_Year") Then
                    ...
                    ret.Append("        <td align='left' > All</td>")
                ...
                ElseIf intData = dt.Rows.Count - 1 Then 'เก็บค่า  ไว้แสดงตอน SUM เมื่อถึง Record สุดท้าย
                ...
                If Val(dt(intData)("AVG_WT").ToString.Replace(":", "")) <> 0 Then
                    ret.Append("        <td align='center' >" & dt(intData)("AVG_WT") & "</td>")
                Else
                    ret.Append("        <td align='center' >00:00:00</td>")
                End If
                If Val(dt(intData)("AVG_HT").ToString.Replace(":", "")) <> 0 Then
                    ret.Append("        <td align='center' >" & dt(intData)("AVG_HT") & "</td>")
                Else
                    ret.Append("        <td align='center' >00:00:00</td>")
                End If
