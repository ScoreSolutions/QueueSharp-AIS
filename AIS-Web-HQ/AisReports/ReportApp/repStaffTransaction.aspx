<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repStaffTransaction.aspx.vb" Inherits="ReportApp_repStaffTransaction" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Staff Transaction Report
                </td>
            </tr>
            <tr>
