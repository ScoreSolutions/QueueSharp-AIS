<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repSummaryShopPerformanceReportByStaff.aspx.vb" Inherits="ReportApp_repSummaryShopPerformanceReportByStaff" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Summary Shop Performance Report by Staff
                </td>
            </tr>
            <tr>
