<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repWaitingTimeHandlingTimeByShop.aspx.vb" Inherits="ReportApp_repWaitingTimeHandlingTimeByShop" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Waiting Time and Handling Time by Shop Report
                </td>
            </tr>
            <tr>
