<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repAppointmentReportByService.aspx.vb" Inherits="ReportApp_repAppointmentReportByService" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Appointment Report By Service
                </td>
            </tr>
            <tr>
