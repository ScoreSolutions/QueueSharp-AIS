<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repWaitingTimeHandlingTimeByAgent.aspx.vb" Inherits="ReportApp_repWaitingTimeHandlingTimeByAgent" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Waiting Time and Handling Time by Staff Report
                </td>
            </tr>
            <tr>
