<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repWaitingTimeHandlingTimeBySkill.aspx.vb" Inherits="ReportApp_repWaitingTimeHandlingTimeBySkill" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Waiting Time and Handling Time by Skill Report
                </td>
            </tr>
            <tr>
