<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repCustomerByCategory.aspx.vb" Inherits="ReportApp_repCustomerByCategory" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Customer Contact by Category/Sub Category Report
                </td>
            </tr>
            <tr>
