<%@ Page Language="VB" AutoEventWireup="false" CodeFile="repSummaryShopPerformanceReportByDaily.aspx.vb" Inherits="ReportApp_repSummaryShopPerformanceReportByDaily" %>
        ...
        <table width="100%" class="table_input">
            <tr>
                <td class="section_header">
                    ...
                    &nbsp;&nbsp; Show Reports&nbsp; : Summary Shop Performance by Daily
                </td>
            </tr>
            <tr>
