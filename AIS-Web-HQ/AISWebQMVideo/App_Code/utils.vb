...
Public Class utils
    ...
    Function GetServiceLog(ByVal ShopID As String, ByVal Agent As String, ByVal Service As String, ByVal Q As String, ByVal mob As String, ByVal TimeFrom As String, ByVal TimeTo As String, ByVal conn As SqlConnection, ByVal dfrom As String, ByVal dto As String, ByVal CounterID As String) As DataTable
        Dim whLog As String = ""
        Dim Sql As String = ""
        Dim tmpDate As String = ""
        ...
        Sql += " left join tb_qm_transfer_log qm on qm.service_date=q.service_date " & vbNewLine
