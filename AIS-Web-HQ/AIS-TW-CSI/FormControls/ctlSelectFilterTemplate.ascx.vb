...
Partial Class FormControls_ctlSelectFilterTemplate
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        lblSearchDateFrom.Text = ""
        lblSearchDateTo.Text = ""
    ...
    Public Sub ClearSelectFilterID()
    ...
    Protected Sub btnPopSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopSearch.Click
        ...
        If lblSearchDateFrom.Text.Trim <> "" And lblSearchDateTo.Text.Trim <> "" Then
            wh += " and (convert(varchar(8),f.preiod_datefrom,112) between '" & lblSearchDateFrom.Text & "' and '" & lblSearchDateTo.Text & "'"
            wh += " or convert(varchar(8),f.preiod_dateto,112) between '" & lblSearchDateFrom.Text & "' and '" & lblSearchDateTo.Text & "'"

            wh += " or '" & lblSearchDateFrom.Text & "' between convert(varchar(8),f.preiod_datefrom,112) and convert(varchar(8),f.preiod_dateto,112) "
            wh += " or '" & lblSearchDateTo.Text & "' between convert(varchar(8),f.preiod_datefrom,112) and convert(varchar(8),f.preiod_dateto,112))"
        End If
