...
<div style="overflow:scroll;overflow-x:hidden; height:120px;width:90%;border-width:1px;border-style: inset;box-shadow:inset 1px 1px 5px gray;behavior: url('../Template/PIE.htc');">
