<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="twReportCSI.aspx.vb" Inherits="TWCSIWebApp_twReportCSI" %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >   
                        ...
                        <tr>
                            ...
                            <td align="left" class="Csslbl" colspan="3" >
                                <uc2:cmbComboBox ID="cmbLocationCode" runat="server" Width="610px" IsNotNull="false" AutoPosBack="true" DefaultDisplay="All" />
                            </td>
                        </tr>
