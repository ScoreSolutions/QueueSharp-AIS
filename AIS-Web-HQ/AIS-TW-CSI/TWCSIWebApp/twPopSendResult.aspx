<%@ Page Language="VB" AutoEventWireup="false" EnableEventValidation="false"  CodeFile="twPopSendResult.aspx.vb" Inherits="TWCSIWebApp_twPopAddDataForSend" %>
        ...
        <center>
            <asp:GridView ID="gvResultList" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns> 
                    ...
                    <asp:BoundField DataField="order_type_name" HeaderText="Order Type" >
