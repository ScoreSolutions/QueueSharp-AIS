<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="twFilterTemplateList.aspx.vb" Inherits="TWCSIWebApp_twFilterTemplateList" %>
                ...
                <asp:GridView ID="gvFilterList" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns> 
                        ...
                        <asp:TemplateField ShowHeader="false" >
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgVerify" runat="server" OnClick="imgVerify_Click" ImageUrl="~/images/ico_verify_data.jpg" ToolTip="Verify Data" CausesValidation="false" CommandArgument="<%# Bind('id') %>" ></asp:ImageButton>
