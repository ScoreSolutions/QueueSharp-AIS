<%@ Page Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="twActivity.aspx.vb" Inherits="TWCSIWebApp_twActivity" title="Untitled Page" %>
                       ...
                       <%-- <asp:BoundField DataField="Category_Name" HeaderText="Category" SortExpression="Category_Name">
                        ...
                        <asp:BoundField DataField="subCategory_Name" HeaderText="Sub Category" SortExpression="subCategory_Name">
                         ...
                         <asp:TemplateField HeaderText="" ShowHeader="True" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <HeaderTemplate>
                                <asp:Label ID="lblHeadCategory" runat="server" Text="Category"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="" ShowHeader="True" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemStyle HorizontalAlign="Left" Width="100px" />
                            <HeaderTemplate>
                                <asp:Label ID="lblHeadSubCategory" runat="server" Text="Sub Category"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblSubCategory" runat="server" Text='<%# Bind("subCategory_Name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
