<%@ Page Title="" Language="VB" MasterPageFile="~/Template/ContentMasterPage.master" AutoEventWireup="false" CodeFile="twReportNPS_SCORE.aspx.vb" Inherits="TWCSIWebApp_twReportNPS_SCORE" %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >   
                        ...
                        <tr>
                            ...
                            <td align="left" class="Csslbl" colspan="3" >
                                <uc2:cmbComboBox ID="cmbLocationCode" runat="server" Width="590px" AutoPosBack="true" IsNotNull="false" DefaultDisplay="All" />
                            </td>
                        </tr>
