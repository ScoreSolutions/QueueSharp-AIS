...
Namespace TABLE
    ...
    Public Class TbStaffSmsConfigShLinqDB
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_STAFF_SMS_CONFIG by specified ROWGUID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_STAFF_SMS_CONFIG by specified ROWGUID key is retrieved successfully.
        '/// <param name=cROWGUID>The ROWGUID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, COUNTER_ID, MULTIPLY, MOBILE_NO, ROWGUID)"
                Sql += " VALUES("
