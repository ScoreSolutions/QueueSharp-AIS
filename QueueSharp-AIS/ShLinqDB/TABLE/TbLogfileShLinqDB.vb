...
Namespace TABLE
    ...
    Public Class TbLogfileShLinqDB
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_LOGFILE by specified ROWGUID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_LOGFILE by specified ROWGUID key is retrieved successfully.
        '/// <param name=cROWGUID>The ROWGUID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, CQ_ID, LOG_DATE, QUEUE_NO, CUSTOMER_ID, USER_ID, ITEM_ID, COUNTER_ID, FLAG, STATUS, ROWGUID)"
                Sql += " VALUES("
