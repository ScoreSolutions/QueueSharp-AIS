...
Namespace TABLE
    ...
    Public Class TbCounterCustomertypeShLinqDB
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_COUNTER_CUSTOMERTYPE by specified ROWGUID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_COUNTER_CUSTOMERTYPE by specified ROWGUID key is retrieved successfully.
        '/// <param name=cROWGUID>The ROWGUID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
