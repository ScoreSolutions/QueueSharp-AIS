...
Namespace Common.Utilities
    Public Class SqlDB
        ...
        Private Shared Function PingServer(ByVal ServerIPAddress As String) As Boolean
            Dim ret As Boolean = False

            If My.Computer.Network.Ping(ServerIPAddress, 500) = True Then
                ret = True
            End If
            Return ret
        End Function
        ...
        Private Shared Function GetCurrentDB() As String
            ...
            'Dim conn As New SqlConnection(DisplayConnectionString)
            'Try
            '    conn.Open()
            '    Dim dt As New DataTable
            '    Dim da As New SqlDataAdapter("select config_value from TB_SETTING where config_name='CurrentDB'", conn)
            '    da.Fill(dt)
        ...
        Public Shared Function GetDateNowFromDB(ByVal trans As SqlTransaction) As DateTime
            Dim ret As DateTime
