...
Public Class frmChooseService
    ...
    Sub SetLogo()
        Try
            Dim logopath As String = Engine.Common.ShopConnectDBENG.GetShopConfig(INIFileName, "LogoKioskEloPath", SoftwareName, "frmChooseService.SetLogo")
            If File.Exists(logopath) = False Then
                logopath = Application.StartupPath & "\Images\logo.jpg"
            End If
            PictureBox6.BackgroundImage = Image.FromFile(logopath)
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        'DeBug += DateTime.Now.ToString("HH:mm:ss.fff") & " : After DateNow" & vbNewLine
        ...
        If IsPrint = True Then
            'DeBug += DateTime.Now.ToString("HH:mm:ss.fff") & " : Before Print1" & vbNewLine
            ...
            'DeBug += DateTime.Now.ToString("HH:mm:ss.fff") & " : Before Print2" & vbNewLine
            Dim p As New PrintDocument
            p.PrintController = New Printing.StandardPrintController
            'DeBug += DateTime.Now.ToString("HH:mm:ss.fff") & " : Before Print3" & vbNewLine
            AddHandler p.PrintPage, AddressOf pd_PrintPage
            'DeBug += DateTime.Now.ToString("HH:mm:ss.fff") & " : Before Print4" & vbNewLine
            p.Print()
