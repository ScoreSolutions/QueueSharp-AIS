...
Public Class frmKiosCapture
    ...
    Sub SetLogo()
        Try
            Dim logopath As String = Engine.Common.ShopConnectDBENG.GetShopConfig(INIFileName, "LogoKioskEloPath", SoftwareName, "frmKioskCapture.SetLogo")
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            PictureBox1.Location = New Point(FormWidth - 270, 9)
