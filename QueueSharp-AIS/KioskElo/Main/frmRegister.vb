...
Public Class frmRegister
    ...
    Sub SetLogo()
        Try
            Dim logopath As String = Engine.Common.ShopConnectDBENG.GetShopConfig(INIFileName, "LogoKioskEloPath", SoftwareName, "frmRegister.SetLogo")
            If File.Exists(logopath) = False Then
                logopath = Application.StartupPath & "\Images\logo.jpg"
            End If
    ...
    Private Sub frmRegister_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        'executeSQL(Sql, INIFileName, SoftwareName, "frmRegister_Shown")
