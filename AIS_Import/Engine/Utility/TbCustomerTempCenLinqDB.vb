...
Namespace Utilities
    ...
    Public Class TbCustomerTempCenLinqDB
        ...
        Public Property CAMPAIGN_NAME() As String
            ...
            End Set
        End Property
        <Column(Storage:="_CAMPAIGN_NAME_EN", DbType:="VarChar(100)")> _
        Public Property CAMPAIGN_NAME_EN() As String
            ...
            End Set
        End Property
        <Column(Storage:="_CAMPAIGN_DESC", DbType:="VarChar(200)")> _
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SqlTransaction) As TbCustomerTempCenLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(ByVal whText As String, ByVal trans As SqlTransaction) As TbCustomerTempCenLinqDB
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
