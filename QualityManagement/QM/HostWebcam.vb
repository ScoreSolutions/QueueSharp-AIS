...
#End Region
    ...
    Private Function HostCue(ByVal QNo As String) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            QM.Errorlog("HostWebcam.HostCue : Exception : " & ex.Message & " HostCapture.Stopped: " & HostCapture.Stopped.ToString & " HostCapture.Cued:" & HostCapture.Cued.ToString & vbNewLine & ex.StackTrace)
            Return False
        End Try
    End Function
    ''' <summary>
    ...
    Public Sub HostStart()
        Try
            ...
            Else
                ...
                Else
                    'Return False
                    Errorlog("HostWebCam : SetCueFlag = False And SetCaptureFlag = False")
                End If
            End If
        Catch ex As Exception
            'Return False
            Errorlog("HostWebCam : " & ex.Message & vbNewLine & ex.StackTrace)
        End Try
    End Sub
