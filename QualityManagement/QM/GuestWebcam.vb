...
Public Class GuestWebcam
    ...
    Private Function CheckVideoCompressors(ByVal InputDeviceIndex As Integer) As Boolean
        Try
            ...
            Dim ConfigINI As New Profile.Ini(ini.GetValue("Setting", "CamConfig").ToString)
    ...
    Public Function GuestCue(ByVal Qid As String) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            QM.Errorlog("QM.GuestWebcam.GuestCue : Exception : " & ex.Message & " GuestCapture.Stopped: " & GuestCapture.Stopped.ToString & " GuestCapture.Cued:" & GuestCapture.Cued.ToString & vbNewLine & ex.StackTrace)
            Return False
        End Try
    End Function
    ''' <summary>
    ...
    Public Sub GuestStart()
        Try
            ...
            Else
                ...
                Else
                    'Return False
                    Errorlog("GuestWebCam : SetCueFlag = False And SetCaptureFlag = False")
                End If
            End If
        Catch ex As Exception
            Errorlog("GuestWebCam : " & ex.Message & vbNewLine & ex.StackTrace)


        End Try
    End Sub

    Private Sub Errorlog(ByVal ErrMsg As String)
