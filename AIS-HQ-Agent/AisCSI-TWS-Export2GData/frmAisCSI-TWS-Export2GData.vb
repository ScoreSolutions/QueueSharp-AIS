...
Public Class frmAisCSI_TWS_Export2GData
    Dim IniFileName As String = Application.StartupPath & "\Config.ini"
    Private Sub frmAisCSI_TWS_Export2GData_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
            If My.Application.CommandLineArgs.Count > 0 Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Dim FileName As String = Application.StartupPath & "\Temp\CSI_TWS_" & vMonth & ".xlsx"
                    Using exPke As New ExcelPackage(New FileInfo(FileName))
                        ...
                        TWSSendEmail(MailSubject, MailTo, MailCC, CreateMailContent(vMonth), FileName)
                    End Using
                End If
        ...
        Catch ex As Exception
            Engine.Common.FunctionEng.SaveErrorLog("frmAisCSI-TWS-Export2GData.Shown", "Exception :" & ex.Message & vbNewLine & ex.StackTrace, "\ErrorLog\", "AisCSI-TWS-Export2GData")
        End Try
        Application.Exit()
    End Sub
    ...
    Private Function TWSSendEmail(ByVal MailSubject As String, ByVal MailTo As String, ByVal MailCC As String, ByVal MailContent As String, ByVal MailAttFile As String) As Boolean
