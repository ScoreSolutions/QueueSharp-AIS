...
#Region "_FilterData"
    Public Sub FilterData()
        Try
            ...
            If fDt.Rows.Count > 0 Then
                ...
                lSql += " where fb.tw_filter_id in (" & lID & ")"
                ...
                Dim Query As String = GetQueryDataAllLocation(WhText, "PAYMENT")
                ...
                Query += " UNION ALL " & vbNewLine & GetQueryDataAllLocation(WhText, "SFF")
                ...
                If dDt.Rows.Count > 0 Then
                    ...
                    Next
                Else
                    CreateLogFile("Query Expired : " & vbNewLine & Query)
                End If
                dDt.Dispose()
            End If
            fDt.Dispose()
    ...
    Private Function GetQueryDataAllLocation(ByVal whText As String, ByVal SourceType As String) As String
        ...
        sql += "            and order_type_name='" & SourceType & "'" & vbNewLine
        sql += " )" & vbNewLine
