...
#Region "CustomerProfile"
        ...
        Private Function GetCustomerProfileFormGW(ByVal MobileNo As String, ByVal IsArBalance As Boolean, ByVal IsCampaign As Boolean, ByVal SessionID As String, ByVal ShopCode As String) As pCen.TbCustomerCenParaDB
            ...
            Catch ex As Exception
                ...
                Try
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCustomerProfileFromGW", URL1 & " Exception : " & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Dim webRequest As WebRequest
                    Dim webresponse As WebResponse
                ...
                Catch ex1 As Exception
                    ...
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCustomerProfileFromGW", URL2 & " Exception1 : " & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return ret
        End Function
        ...
        Private Function GetArBalance(ByVal para As pCen.TbCustomerCenParaDB) As pCen.TbCustomerCenParaDB
            ...
            Catch ex As Exception
                ...
                Try
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetArBalance", URL1 & " Exception : " & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Dim webRequest As WebRequest
                    Dim webresponse As WebResponse
                    webRequest = webRequest.Create(URL2)
                    webresponse = webRequest.GetResponse()
                ...
                Catch ex1 As Exception
                    ...
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetArBalance", URL2 & " Exception1 : " & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return para
        End Function
...
#Region "Get Customer Campaign"
        ...
        Private Sub GetCampaignPostEvent(ByVal SessionID As String, ByVal TreamentCode As String, ByVal MobileNo As String, ByVal ParentCode As String, ByVal ChildCode As String, ByVal Score As String, ByVal OfferCode As String, ByVal ShopCode As String)
            ...
            Catch ex As Exception
                ...
                Try
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignPostEvent", URL1 & " Exception : " & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Dim webRequest As WebRequest
                    Dim webresponse As WebResponse
                    webRequest = webRequest.Create(URL2)
                    webresponse = webRequest.GetResponse()
                    ...
                    End If
                Catch ex1 As Exception
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignPostEvent", URL2 & " Exception1 : " & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
        End Sub
        ...
        Private Function GetCampaignOffer(ByVal SessionID As String) As String()
            ...
            Catch ex As Exception
                ...
                Try
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignOffer", URL1 & " Exception : " & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Dim webRequest As WebRequest
                    Dim webresponse As WebResponse
                    webRequest = webRequest.Create(URL2)
                    webresponse = webRequest.GetResponse()
                    ...
                    End If
                Catch ex1 As Exception
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignOffer", URL2 & " Exception1 : " & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return ret
        End Function
        ...
        Private Function GetCampaignStartSession(ByVal para As pCen.TbCustomerCenParaDB, ByVal SessionID As String) As Boolean
            ...
            Catch ex As Exception
                Dim URL2 As String = FunctionEng.GetQisDBConfig("InteractStartSessionURL2") & InputPara
                Try
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignStartSession", URL1 & " Exception : " & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Dim webRequest As WebRequest
                    Dim webresponse As WebResponse
                    webRequest = webRequest.Create(URL2)
                    webresponse = webRequest.GetResponse()
                ...
                Catch ex1 As Exception
                    para.RESPONSE_MSG = ex1.Message
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetCampaignStartSession", URL2 & " Exception1 : " & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return ret
        End Function
...
#Region "Get Customer From HQ DB"
        Private Function GetCustomerFromHQ(ByVal MobileNo As String) As pCen.TbCustomerCenParaDB
            ...
            Else
                ...
                FunctionEng.SaveErrorLog("MobileEng.GetCustomerFromHQ", "Mobile No : " & MobileNo & "  " & lnq.ErrorMessage, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
            End If
        ...
        Public Function SendSMS(ByVal MobileNo As String, ByVal Msg As String) As SMSResponsePara
            ...
            Try
                ...
                If ret.RESULT = False Then
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendSMS", ret.ERROR_RESPONSE & " URL :" & SMS_URL1, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                Else
                    If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                ...
                End If
            Catch ex As Exception
                FunctionEng.SaveErrorLog("GateWayServiceENG.SendSMS", SMS_URL1 & " Exception :" & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                ...
                Try
                    ...
                    ret = GetSMSMsg(webRequest, webresponse, InputPara)
                    If ret.RESULT = False Then
                        FunctionEng.SaveErrorLog("GateWayServiceENG.SendSMS", ret.ERROR_RESPONSE & " URL :" & SMS_URL2, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Else
                        If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                ...
                Catch ex1 As Exception
                    ...
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendSMS", SMS_URL2 & " Exception :" & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
...
#Region "ATSR Post Servey"
        Public Function SendATSR(ByVal MobileNo As String, ByVal QueueID As String, ByVal ShopCode As String, ByVal TemplateID As String) As Boolean
            ...
            Try
                ...
                If ret = False Then
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendATSR", "ATSR ERROR : " & _AtsrError & "   URL :" & URL1, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                Else
                    If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                ...
                End If
            Catch ex As Exception
                FunctionEng.SaveErrorLog("GateWayServiceENG.SendATSR", URL1 & " Exception :" & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                ...
                Try
                    ...
                    ret = SendATSRMsg(webresponse)
                    If ret = False Then
                        FunctionEng.SaveErrorLog("GateWayServiceENG.SendATSR", "ATSR ERROR : " & _AtsrError & "   URL :" & URL2, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Else
                        If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                    ...
                    End If
                Catch ex1 As Exception
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendATSR", URL2 & " Exception :" & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return ret
        End Function
        ...
        Public Function CreateSiebelActivity(ByVal data As CenParaDB.CSI.SiebelReqPara) As CenParaDB.CSI.SiebelResponsePara
            ...
            InputPara += "&SIEBEL_OWNERNAME=" & data.SIEBEL_OWNERNAME
        ...
        Private Function CallWebService(ByVal InputPara As String) As CenParaDB.CSI.SiebelResponsePara
            ...
            If ret.RESULT = False Then
                FunctionEng.SaveErrorLog("AIS-HQ-Agent.GateWayServiceENG.CallWebService", ret.ErrorMessage & " " & SIEBEL_URL1, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                ...
                If ret.RESULT = False Then
                    ...
                    FunctionEng.SaveErrorLog("AIS-HQ-Agent.GateWayServiceENG.CallWebService", "AIS-HQ-Agent.GenSiebelENG.CallWebService : " & ret.ErrorMessage & " " & SIEBEL_URL2, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End If
            End If
            Return ret
        End Function
        ...
        Public Function GetATSRSurveyResult(ByVal QUNIQID As String) As ATSRResultPara
            ...
            Try
                ...
                If ret.RESULT <> "DONE" Then
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetATSRSurveyResult", "URL :" & URL1, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                Else
                    If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                ...
                End If
            Catch ex As Exception
                FunctionEng.SaveErrorLog("GateWayServiceENG.GetATSRSurveyResult", URL1 & " Exception :" & ex.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                ...
                Try
                    ...
                    ret = GetATSRSurverResultMsg(webresponse, ret)
                    If ret.RESULT <> "DONE" Then
                        FunctionEng.SaveErrorLog("GateWayServiceENG.GetATSRSurveyResult", "URL :" & URL2, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Else
                        If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                    ...
                    End If
                Catch ex1 As Exception
                    FunctionEng.SaveErrorLog("GateWayServiceENG.GetATSRSurveyResult", URL2 & " Exception :" & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
            Return ret
        End Function
...
#Region "Send Email"
        Public Function SendEmail(ByVal EmailTo As String, ByVal MailSubject As String, ByVal msg As String) As Boolean
            ...
            Try
                ...
                If ret = False Then
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendEmail", "Send Email Fail" & " URL :" & SMS_URL1, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                Else
                    If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
            ...
            Catch ex As Exception
                ...
                Try
                    ...
                    ret = GetEmailMsg(webRequest, webresponse, InputPara)
                    If ret = False Then
                        FunctionEng.SaveErrorLog("GateWayServiceENG.SendEmail", "Send Email Fail" & " URL :" & SMS_URL2, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                    Else
                        If FunctionEng.GetQisDBConfig("AGENT_SAVE_TRANS_LOG") = "Y" Then
                    ...
                    End If
                Catch ex1 As Exception
                    FunctionEng.SaveErrorLog("GateWayServiceENG.SendEmail", SMS_URL2 & " Exception :" & ex1.Message, Application.StartupPath & "\ErrorLog\", "GateWayServiceENG")
                End Try
            End Try
