...
Public Class frmMonitorStackServer
    ...
    Private Sub frmMonitorStackServer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim eM As New Engine.Info.MonitorComputerInfoENG
        eM.MonitorComputerInfo()
    End Sub
    ...
    Private Function GetCPU() As String
        ...
        For Each mo In moReturn
            ...
            ret += "CPU Usage : " & ProcessName & " ## " & PercentUsage & " %" & vbNewLine
        Next
        moSearch.Dispose()
        moReturn.Dispose()
        Return ret
    ...
    Private Function GetRam() As String
        ...
        ret = "Available Physical Memory :" & (ComInfo.AvailablePhysicalMemory / (1024 ^ 3)).ToString("#,##0.00") & " GB" & vbNewLine
        Return ret
    End Function
